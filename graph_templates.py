...
C = [(7, 1), (11, 13), (16, 8), (6, 11), (12, 6), (12, 13), (13, 15), (10, 17),
     ...
     (7, 11), (20, 6)]
s0 = [20, 12, 5, 10, 14, 18, 2, 1, 9, 7, 11, 13, 15, 10, 17, 3, 19, 8, 4, 16,
      4, 0, 6, 20, 12, 13, 15, 2, 1, 11, 20, 6, 11, 6, 0, 12, 13, 15, 5, 17]
G = Graph(x, y, C)
G.create_shortest_paths(dijkstra)
...
G.create_shortest_paths(dijkstra)
graph_list.append((G, s0))
x = [12,  0,  6, 18, 18, 15, 19,  2,  4,  8,  9, 13,  5, 15,  8, 2]
y = [12,  3, 20, 11,  1,  8, 16, 17,  0,  2, 16,  4, 13, 17,  7, 8]
C = [(1, 8), (7, 12), (2, 10), (8, 9), (4, 11), (5, 3), (3, 6), (6, 3), (4, 5),
     (7, 15), (14, 15), (14, 11), (14, 9), (15, 8), (14, 12), (12, 0), (9, 11),
     (1, 15), (12, 2), (13, 6), (3, 13), (13, 0), (13, 10), (12, 10), (15, 12),
     (14, 0), (0, 3), (0, 5), (7, 2), (3, 4), (10, 0), (11, 5), (11, 0)]
s0 = [0, 5, 3, 0, 14, 15, 12, 2, 7, 15, 8, 9, 11, 4, 3, 13, 6, 3, 5, 11, 5, 4]
G = Graph(x, y, C)
G.create_shortest_paths(dijkstra)
graph_list.append((G, s0))
